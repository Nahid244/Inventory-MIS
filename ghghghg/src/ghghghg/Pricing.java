...
public class Pricing extends JPanel {
	    ...
	    public void delete(){
	     ...
	     Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
	      ...
	      Statement statement = connection.createStatement();  
	       ...
	       statement.executeUpdate(" delete from Pricing where p_id='"+s1+"' and price='"+s2+"' ");
...
//	      statement.close();
	    ...
	    public void insert(){
	     ...
	     Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
	      ...
	      statement.execute(" insert into Pricing "  + " values ( '"+s1+"', '"+s3+"' )");
	      ResultSet resultSet=null;
//	      resultSet.close();
//	      statement.close();
	    ...
	    textfield5.setText("");
	        	  ...
	        	  JOptionPane.showMessageDialog(null,"please insert valid info");
	          }  
	    ...
	    public void selected(){
	    	  table.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
	  			...
	  			textfield2.setText(table.getModel().getValueAt(index, 1).toString());	
	    ...
	    public void update(){
	    	  but1.addActionListener(new ActionListener(){
	              ...
	              int s3 =Integer.parseInt(textfield2.getText());
	     ...
	     Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
	      ...
	      statement.execute(" update Pricing set p_id='"+s1+"',price="+s3+" where p_id='"+s1+"'"); 
	      ResultSet resultSet=null;
//	      resultSet.close();
//	      statement.close();
