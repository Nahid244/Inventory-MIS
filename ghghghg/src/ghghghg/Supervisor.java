...
public class Supervisor extends JPanel {
    ...
    public void init(){
  	  ...
  	  Constants.tableloader("Supervisor",table,scrollpane,dtm);
   ...
   Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
    ...
    Statement statement = connection.createStatement();  
     ...
     statement.executeUpdate(" delete from Supervisor where supervisor_id='"+s1+"'  ");
...
//    statement.close();
  ...
  JOptionPane.showMessageDialog(null,"Records deleted");
   ...
   Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
    ...
    statement.execute(" insert into Supervisor "  + " values ( '"+s1+"', '"+s2+"','"+s3+"' )");
    ResultSet resultSet=null;
//    resultSet.close();
//    statement.close();
  ...
  textfield5.setText("");
    ...
    public void update(){
     ...
     Connection connection = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=austproject;integratedSecurity=true");  
      ...
      statement.execute(" update Supervisor set supervisor_id='"+s1+"',name='"+s2+"',workingarea='"+s3+"' where supervisor_id='"+s1+"'"); 
      ResultSet resultSet=null;
//      resultSet.close();
//      statement.close();
